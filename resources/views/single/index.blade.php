...
<div id="main-wrapper" class="uc-offcanvas-wrapper uc-offcanvas-left slide-along">
<!-- Page Preloader -->
        ...
        <div class="container">
            <div class="row">
                <div class="footer">
                    ...
                    <div class="col-sm-6">
                        <p>© Copyright 2016-Tech News . Design by: <a href="https://uicookies.com">uiCookies</a> </p>
                    </div>
                    <div class="col-sm-3">
...
<div class="uc-mobile-menu uc-mobile-menu-effect uc-offcanvas-init uc-offcanvas-container">
    <button type="button" class="close" aria-hidden="true" data-toggle="offcanvas" id="uc-mobile-menu-close-btn">×</button>
    <div>
        <div>
            <ul id="menu">
